...
#### create volcano plots for sample level deg
```{r}
...
myComplexHeatmap = function(mat, width, vec){
  ...
  plot=
        ComplexHeatmap::Heatmap(matrix = t(scale(t(mat))), name="Z-score", km=1, 
                        ...
                        column_title_side = "bottom", column_names_rot = 0, top_annotation = column_ha, width = width) 
...
myComplexHeatmap(mat = ALS_DAM_down.regulated.genes_5Clusters, width = unit(5, "cm"), vec=df_disease_down$df_disease_down[c(1,2,3,4,5)])
myComplexHeatmap(mat = ALS_DAM_down.regulated.genes_allClusters, width = unit(10, "cm"), vec=df.up.down$down.ratio)
myComplexHeatmap(mat = ALS_DAM_up.regulated.genes_5Clusters, width = unit(5, "cm"), vec=df_disease_up$df_disease_up[c(1,2,3,4,5)])
myComplexHeatmap(mat = ALS_DAM_up.regulated.genes_allClusters, width = unit(10, "cm"), vec=df_disease_up$df_disease_up)
...
microgliaReshape.markers.sig = microgliaReshape.markers[which(microgliaReshape.markers$p_val_adj<0.05 & abs(microgliaReshape.markers$avg_logFC)>0.35),] 
...
df.up.down
table(microgliaReshape.markers.sig$cluster)

table(ALS_DAM.sig.up%in%rownames(microgliaReshape))

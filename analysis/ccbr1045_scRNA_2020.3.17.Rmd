...
myVolcano = function(file,contrast, dir){
  ...
  deg.sig = deg[which(deg$p_val_adj<0.05&abs(deg$avg_logFC)>0.2),]
  write.table(deg.sig, paste0("results/", dir, "/", contrast, "_degs_sig",".txt"), quote = F, sep = "\t")
  
  deg$significance = ifelse(deg$p_val_adj<0.05&abs(deg$avg_logFC)>0.2, "sig", "ns")
...
myVolcano(file = "degs.cluster5-cluster1.txt", dir = "microgliaCluster5", contrast = "cluster5-cluster1")

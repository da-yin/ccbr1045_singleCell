...
myComplexHeatmap = function(mat, width){
  ...
  plot=
        ComplexHeatmap::Heatmap(matrix = t(scale(t(mat))), name="Z-score", km=1, 
                        col=colorRampPalette(rev(brewer.pal(n = 7, name ="RdYlBu")))(100), row_names_gp = gpar(fontsize = 9, fontface = "bold"),
                        column_names_gp = gpar(fontsize = 12, fontface = "bold"),
                        cluster_columns = T, column_title = "cluster", column_title_gp = gpar(fontsize = 15, fontface = "bold"), 
                        column_title_side = "bottom", column_names_rot = 0, width = width) # top_annotation = column_ha
